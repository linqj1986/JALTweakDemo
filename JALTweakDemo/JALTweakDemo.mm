...
static void _logos_method$_ungrouped$CLLocationManager$setDelegate$(_LOGOS_SELF_TYPE_NORMAL CLLocationManager* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id arg1) {
    locationDelegate = arg1;
    _logos_orig$_ungrouped$CLLocationManager$setDelegate$(self, _cmd, arg1);
}
...
static void _logos_method$_ungrouped$SpringBoard$btnAction0$(_LOGOS_SELF_TYPE_NORMAL SpringBoard* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, id btn) {
    ...
    [ProcessSpringBoard.shareInstance touch];
}
...
static UIWindow * _logos_method$_ungrouped$SpringBoard$lastWindow(_LOGOS_SELF_TYPE_NORMAL SpringBoard* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {

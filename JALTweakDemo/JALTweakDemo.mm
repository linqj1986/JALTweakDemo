...
@class UnityAppController; @class SpringBoard; @class CMPedometer; @class CLLocationManager; @class UIApplication; @class CMStepCounter; @class SBHomeHardwareButtonActions; @class CMPedometerData; @class CLLocation; 
